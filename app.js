                ...
                <div class="start-screen">
                    <div class="start-card">
                        <div class="start-logo">
                            <img src="images/kcna-logo.png" alt="KCNA Logo" loading="lazy">
                        </div>
                        <h1 class="start-title">KCNA Practice Exam</h1>
                        <p class="start-subtitle">Kubernetes and Cloud Native Associate Certification</p>
